...
public:
	...
	void changeCrawl(int height);							//crawls through entire tree updating hash values
	vector<TTnode*> nodesAtH(TTnode* curTree, int height);	//returns a vector of nodes at height h for the changeCrawl function
